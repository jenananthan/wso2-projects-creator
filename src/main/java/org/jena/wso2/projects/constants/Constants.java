...
public class Constants {
    ...
    public final static String ESB_INBOUND_EP_DIR = "/src/main/synapse-config/inbound-endpoints";
    public final static String ESB_LOCAL_ENTRIES_DIR = "/src/main/synapse-config/local-entries";
    public final static String ESB_MP_DIR = "/src/main/synapse-config/message-processors";
    public final static String ESB_MS_DIR = "/src/main/synapse-config/message-stores";
    public final static String ESB_PROXY_DIR = "/src/main/synapse-config/proxy-services";
    public final static String ESB_SEQUENCES_DIR = "/src/main/synapse-config/sequences";
    public final static String ESB_TASKS_DIR = "/src/main/synapse-config/tasks";
    public final static String ESB_TEMPALATES__DIR = "/src/main/synapse-config/templates";
    public final static String DSS__DIR = "/dataservice";
    ...
    public final static String ROOT_PROJECT_POM_FTL = "project-pom.ftl";
